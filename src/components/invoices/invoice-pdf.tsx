    ...
    <Document>
      <Page>
        <Container>
          ...
          <Box style={{ display: 'flex', flexDirection: 'row', marginBottom: '50px' }}>
          ...
          <Box style={{ display: 'flex', flexDirection: 'row', marginBottom: '80px' }}>
          ...
          <Box style={{ display: 'flex', flexDirection: 'row', width: '70%', marginBottom: '30px' }}>
