    ...
    >
      <>
        ...
        <Box style={{ width: '10%', ...colStyles }}>
          {renderDivider}
          <Typography style={{ fontWeight: 600, marginLeft: '12px' }}>{'Qté'}</Typography>
        </Box>
        <Box style={{ width: '15%', ...colStyles }}>
          {renderDivider}
          <Typography style={{ fontWeight: 600, marginLeft: '12px' }}>{'Prix Unitaire'}</Typography>
        </Box>
        <Box style={{ width: '20%', ...colStyles }}>
          {renderDivider}
          <Typography style={{ fontWeight: 600, marginLeft: '12px' }}>{'Prix Total '}</Typography>
        </Box>
      </>
    </Box>
  );
