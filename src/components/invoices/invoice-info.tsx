  ...
  return (
    <Box style={{ backgroundColor: '#F7FBFF', borderRadius: 3, padding: editable ? '16px 20px' : '12px 16px' }}>
      <Box style={{ height: editable ? 26 : 20, ...lineStyle }}>
        <Typography style={{ minWidth: editable ? '110px' : '80px', ...textStyle }}>Facture No :</Typography>
        {editable ? (
      ...
      <Box style={{ height: editable ? 26 : 20, ...lineStyle }}>
        <Typography style={{ minWidth: editable ? '110px' : '80px', ...textStyle }}>Période Du  :</Typography>
        {editable ? (
      ...
      <Box style={{ height: editable ? 26 : 20, ...lineStyle }}>
        <Typography style={{ minWidth: editable ? '110px' : '80px', ...textStyle }}>AU  :</Typography>
        {editable ? (
